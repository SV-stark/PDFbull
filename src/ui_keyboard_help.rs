...
use iced::widget::{button, column, container, text, Space, scrollable};
...
pub fn keyboard_help_view(_app: &crate::app::PdfBullApp) -> Element<'_, crate::message::Message> {
    let shortcuts = column![
        ...
        shortcut_section("Navigation", vec![
        ...
        text("Press ? or F1 to close this help")
            .size(13)
            .font(INTER_REGULAR)
            .style(|_| iced::widget::text::Style { color: Some(Color::from_rgb8(150, 150, 160)) }),
    ]
    .padding(40)
...
fn shortcut_section<'a>(title: &'a str, items: Vec<(&'a str, &'a str)>) -> Element<'a, crate::message::Message> {
    let mut col = column![
        text(title)
            .size(16)
            .font(INTER_BOLD)
            .style(|_| iced::widget::text::Style { color: Some(Color::from_rgb8(150, 220, 220)) }),
        ...
        col = col.push(
            row![
                ...
                text(action)
                    .size(13)
                    .font(INTER_REGULAR)
                    .style(|_| iced::widget::text::Style { color: Some(Color::from_rgb8(200, 200, 210)) }),
            ]
            .spacing(15)
