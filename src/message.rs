...
pub enum Message {
    ...
    SetPageLayoutMode(crate::models::PageLayoutMode),
    ToggleTwoPageCover,
    FileHovered(bool),
    NextPage,
    PrevPage,
    ...
    ToggleConformanceValidator(bool),
    SetConformanceProfile(usize),
    RunConformanceValidation,
    ConformanceValidated(PdfResult<crate::models::ConformanceReport>),
