...
pub struct PdfBullApp {
    ...
    pub show_header_footer_prompt: bool,
    pub header_input: String,
    pub footer_input: String,
    pub show_permissions_prompt: bool,
...
impl Default for PdfBullApp {
    fn default() -> Self {
        Self {
            ...
            show_header_footer_prompt: false,
            header_input: String::new(),
            footer_input: "Page {page} of {pages}".to_string(),
            show_permissions_prompt: false,
            allow_printing: true,
            allow_copying: true,
            allow_editing: false,
